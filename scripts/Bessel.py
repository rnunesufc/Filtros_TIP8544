...
N = 2
wcF = 2000.0
print(f"--- Filtro Bessel N={N}, wcF={wcF} (Normalizado p/ Mag) ---")

# o uso da normalização por magnitude 'norm="mag"' serve para forçar o ponto de -3dB 
# a estar em wcF, para uma comparação justa com o Butterworth 
num, den = sig.bessel(N, wcF, btype='low', analog=True, norm='mag')
...
numF = [K * w0**2]
denF = [1, 2 * zeta * w0, w0**2]
HF_control_circ = ct.tf(numF, denF)
print(HF_control_circ)
